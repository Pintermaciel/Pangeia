...
class ContasPagar(Base):
    ...
    id_contrato_fornecedor: Mapped[int] = mapped_column('ID_CONTRATO_FORNECEDOR', Integer, nullable=False)
    id_contrato: Mapped[int] = mapped_column('ID_CONTRATO', Integer, nullable=False)
    id_contas_pagar: Mapped[str] = mapped_column('ID_CONTAS_PAGAR', String, primary_key=True, nullable=False)
    id_emp_cli: Mapped[int] = mapped_column('ID_EMP_CLI', Integer, nullable=False)
    id_fornecedor: Mapped[int] = mapped_column('ID_FORNECEDOR', Integer, nullable=False)
    id_despesa: Mapped[int] = mapped_column('ID_DESPESA', Integer, nullable=False)
    ...
    id_conta: Mapped[int] = mapped_column('ID_CONTA', Integer, nullable=False)
